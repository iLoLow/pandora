    ...
    <div className="tableauDeBordWrapper">
      <aside className={isOpen ? "tableauDeBordAside" : "tableauDeBordAside tableauDeBordAsideSmall"}>
        <div className="tableauDeBordAsideHeader">
          <div className={isOpen ? "tableauDeBordAsideBtn" : "tableauDeBordAsideBtn tableauDeBordAsideBtnReverse"} onClick={() => setIsOpen(!isOpen)}>
            <span className="tableauDeBordIcone">
              <svg stroke="#4CA3E8" xmlns="http://www.w3.org/2000/svg" className="tableauDeBordIcone" viewBox="0 0 512 512">
        ...
        <div className="tableauDeBordLinks">
          <NavLink className={({ isActive }) => (isActive ? "link link-active" : "link")} to="/tableaudebord/">
            <span className="tableauDeBordIcone">
          ...
          <NavLink className={({ isActive }) => (isActive ? "link link-active" : "link")} to="/tableaudebord/annonces">
            <span className="tableauDeBordIcone">
              <svg fill="#4CA3E8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        {!!is_admin && (
          <>
            ...
            <div className="tableauDeBordLinks tableauDeBordLinksScroll">
              <NavLink className={({ isActive }) => (isActive ? "link link-active" : "link")} to="/tableaudebord/admin/users">
                <span className="tableauDeBordIcone">
                  <svg fill="#4CA3E8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              ...
              <NavLink className={({ isActive }) => (isActive ? "link link-active" : "link")} to="/tableaudebord/admin/annonces">
                <span className="tableauDeBordIcone">
                  <svg fill="#4CA3E8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              ...
              <NavLink className={({ isActive }) => (isActive ? "link link-active" : "link")} to="/tableaudebord/admin/team">
                <span className="tableauDeBordIcone">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#4CA3E8">
                    <path d="M13 6a3 3 0 11-6 0 3 3 0 016 0zM18 8a2 2 0 11-4 0 2 2 0 014 0zM14 15a4 4 0 00-8 0v3h8v-3zM6 8a2 2 0 11-4 0 2 2 0 014 0zM16 18v-3a5.972 5.972 0 00-.75-2.906A3.005 3.005 0 0119 15v3h-3zM4.75 12.094A5.973 5.973 0 004 15v3H1v-3a3 3 0 013.75-2.906z" />
                  </svg>
                </span>
                <span>Équipe</span>
              </NavLink>
              <NavLink className={({ isActive }) => (isActive ? "link link-active" : "link")} to="/tableaudebord/admin/galerie">
                <span className="tableauDeBordIcone">
                  <svg fill="#4CA3E8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              ...
              <NavLink className={({ isActive }) => (isActive ? "link link-active" : "link")} to="/tableaudebord/admin/Vehicule">
                <span className="tableauDeBordIcone">
                  <svg fill="#4CA3E8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              ...
              <NavLink className={({ isActive }) => (isActive ? "link link-active" : "link")} to="/tableaudebord/admin/abonnement">
                <span className="tableauDeBordIcone">
                  <svg fill="#4CA3E8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              ...
              <NavLink className={({ isActive }) => (isActive ? "link link-active" : "link")} to="/tableaudebord/admin/banner">
                <span className="tableauDeBordIcone">
                  <svg fill="#4CA3E8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              ...
              <NavLink className={({ isActive }) => (isActive ? "link link-active" : "link")} to="/tableaudebord/admin/webhook">
                <span className="tableauDeBordIcone">
                  <svg fill="#4CA3E8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
