import "../../styles/boutique/AdminBoutiqueCard.css";
...
function AdminBoutiqueCard({ item, editHandle = () => {}, deleteHandle = () => {} }) {
  ...
  return (
    <article className="tableauBoutique">
      ...
      {/* Description */}
      <div className="tableauBoutiqueItem desc">
      ...
      <div className="tableauBoutiqueItem btns">
        ...
        <div className="tableauBoutiqueIcone" onClick={deleteHandle}>
...
export default AdminBoutiqueCard;
