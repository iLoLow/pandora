import "../../styles/annonce/AdminAnnonceCard.css";
  ...
  return (
    <div className="tableauAnnonce">
      ...
      <div className="tableauAnnonceItem btns">
        <div className="tableauAnnonceicone" onClick={handleEditAnnonce}>
        ...
        <div className="tableauAnnonceicone" onClick={deleteHandleAnnonce}>
...
export default AdminAnnonceCard;
