...
import DragIcon from "../../assets/move-card-team.svg";
...
function AdminEquipeCard({ equipe, handleEditEquipe = () => {}, deleteHandleEquipe = () => {} }) {
  ...
  return (
    <div className="tableauEquipe" style={style} {...attributes} ref={setNodeRef}>
      <div ref={setActivatorNodeRef} {...listeners} className="dragBtn">
      ...
      <div className="tableauEquipeItem btns">
        <div className="tableauEquipeIcone" onClick={handleEdit}>
        ...
        <div className="tableauEquipeIcone" onClick={handledelete}>
