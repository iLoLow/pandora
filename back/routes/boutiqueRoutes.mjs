...
router.post("/", verifyToken, checkIsAdmin, multerStorage.array("boutique_image"), createBoutiqueItem);
router.get("/", getAllBoutiqueItems);
router.get("/single/:id", getBoutiqueItem);
router.patch("/:id", verifyToken, checkIsAdmin, multerStorage.array("boutique_image"), updateBoutiqueItem);
