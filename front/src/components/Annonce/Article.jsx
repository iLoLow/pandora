          ...
          <div className="articleFooter">
            ...
            <div className="articleLike">
              ...
              <LikeButton displayText={JSON.parse(annonce.liked_users).length} handleClick={likeHandler}>
                <svg className="LikedSvg" fill={isLikedUsers ? "rgb(5, 142, 34)" : "#0d7f90"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
              ...
              <LikeButton displayText={JSON.parse(annonce.disliked_users).length} handleClick={dislikeHandler}>
                <svg className="DislikedSvg" fill={isDislikedUsers ? "rgb(179, 3, 3)" : "#0d7f90"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
